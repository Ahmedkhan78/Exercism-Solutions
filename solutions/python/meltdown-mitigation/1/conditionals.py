...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if float(temperature) < 800 and float(neutrons_emitted) > 500:
        if float(temperature * neutrons_emitted) < 500000:
            return True
    return False
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    current_percent = (generated_power / theoretical_max_power) * 100
