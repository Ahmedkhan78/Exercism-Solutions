...
export function createScoreBoard() {
  // Initialize the scoreboard with one entry
  const scoreBoard = {
...
export function normalizeScore(params) {
  ...
  // Destructure the score and normalizeFunction from the object
  const { score, normalizeFunction } = params;
  
  // Apply the normalization function to the score and return the result
